export const categories = [
  ...
  { id: "STARTUP_FUNDING", label: "Startup Funding" },
  { id: "LEGAL", label: "Legal" },
  { id: "PRODUCT_LAUNCH", label: "Product Launch" },
  { id: "BUSINESS_EXPANSION", label: "Business Expansion" },
  { id: "EVENT_SPONSORSHIP", label: "Event Sponsorship" },
  { id: "RESEARCH_AND_DEVELOPMENT", label: "Research And Development" },
  { id: "EQUIPMENT_PURCHASE", label: "Equipment Purchase" },
  { id: "MARKETING_AND_ADVERTISING", label: "Marketing And Advertising" },
  { id: "WORKFORCE_TRAINING", label: "Workforce Training" },
  { id: "POVERTY_ALLEVIATION", label: "Poverty Alleviation" },
  { id: "EDUCATION_SUPPORT", label: "Education Support" },
  { id: "HEALTHCARE_ASSISTANCE", label: "Healthcare Assistance" },
  { id: "ELDERLY_ASSISTANCE", label: "Elderly Assistance" },
  { id: "ENVIRONMENTAL_CONSERVATION", label: "Environmental Conservation" },
  { id: "HUMAN_RIGHTS", label: "Human Rights" },
  { id: "REFUGEE_AID", label: "Refugee Aid" },
